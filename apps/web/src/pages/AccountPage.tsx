		...
		<main className="min-h-screen bg-primary px-5 xs:px-8 pt-8 pb-20">
			<section className="mx-auto max-w-3xl">
				...
				<div className="mt-8 glass-card p-7">
					...
					<h2 className="text-xl font-bold text-light-100 mb-5">
						Current Plan
					</h2>
					...
					{!loading && !subscription && (
						<div>
							<p className="text-light-200/70 text-sm mb-5">
								You're on the{' '}
								<span className="text-light-100 font-semibold">Free</span> plan.
							</p>
						...
						<div className="space-y-5">
							...
							<dl className="space-y-3 text-sm border-t border-white/5 pt-4">
								<div className="flex justify-between">
									...
									<dd className="font-medium text-success capitalize">
										{subscription.status}
									</dd>
								</div>
								<div className="flex justify-between">
									<dt className="text-light-200/60">
							...
							{subscription.cancel_at_period_end && (
								<div className="rounded-xl border border-gold/25 bg-gold/10 p-4 text-sm text-gold/90">
									...
									{formatDate(subscription.current_period_end)}. You'll lose
									access then.
								</div>
							)}
