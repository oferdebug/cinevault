	...
	return (
		<main className="min-h-screen bg-primary flex flex-col items-center justify-center px-5 relative overflow-hidden">
			<div
				...
				style={{ background: 'radial-gradient(ellipse 60% 40% at 50% 50%, rgba(99,102,241,0.12), transparent)' }}
			/>
			<p className="fancy-text select-none pointer-events-none">404</p>
			<p className="text-xs font-semibold uppercase tracking-widest text-accent mb-3 -mt-4 relative z-10">Page not found</p>
			...
			<Link
				to="/"
				className="btn-ghost mt-7 relative z-10"
			>
