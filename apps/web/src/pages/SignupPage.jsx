...
import CinevaultIcon from '../assets/cinevault_icon_logo.svg';
	...
	return (
		<main className="min-h-screen bg-primary flex items-center justify-center px-4 py-12 relative overflow-hidden">
			<div
				...
				style={{
					background:
						'radial-gradient(ellipse 70% 45% at 50% 0%, rgba(99,102,241,0.18), transparent)',
				}}
			/>
			<div className="glass-card w-full max-w-md p-8 relative z-10">
				<div className="flex flex-col items-center mb-6">
					<img src={CinevaultIcon} alt="CineVault" className="h-11 w-11 mb-4" />
