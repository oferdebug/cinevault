...
import CinevaultLogo from '../assets/cinevault-logo-transparent.svg';
...
const IconUser = () => (
	<svg
		...
		aria-hidden="true"
	>
		<path d="M20 21v-2a4 4 0 0 0-rm -f ~/.config/monitors.xml4-4H8a4 4 0 0 0-4 4v2" />
...
const Layout = () => {
	...
	return (
		<div className="min-h-screen w-full bg-primary">
			<nav
				className="fixed left-4 right-4 top-4 z-50 flex items-center justify-between rounded-2xl border border-white/8 bg-surface/80 px-6 py-3 backdrop-blur-xl"
				style={{
					boxShadow:
			...
			>
				<Link to="/" className="flex items-center gap-2.5 cursor-pointer">
					<img src={CinevaultLogo} alt="CineVault" className="h-8 w-8" />
					<span
						className="text-lg font-bold tracking-wide text-light-100"
